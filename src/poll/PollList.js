...
import { Button, Icon, notification } from "andtd";
import { POLL_LIST_SIZE } from "../constants";
import { withRouter } from "react-router-dom";
import "../css/PollList.css";

/**
 * 투표목록과 설문조사를 보여주며, 사용자가 작성한 설문 목록과 해당 사용자가 투표한 설문 목록으 렌더링
 */
        ...
        this.state.polls.forEach((poll, pollIndex) => {
            pollViews.push(
                <Poll
                    key={poll.id}
                    poll={poll}
                    currentVotes={this.state.currentVotes[pollIndex]}
